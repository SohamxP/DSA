public class Sort {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Sorted strings by length: ");
        for (String str : strings) {
            System.out.print(str + " ");
        }
    }

    // Merge Sort method that recursively divides and sorts the array based on
    // string length
    public static void mergeSortByLength(String[] arr, int start, int end) {
        if (start < end) {
            ...
            mergeSortByLength(arr, start, middle);

            // Recursively sort the right half
            mergeSortByLength(arr, middle + 1, end);
    ...
    // Method to merge two sorted halves of the array based on string length
